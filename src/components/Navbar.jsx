...
>
  <div className="main-container w-full flex justify-between items-center">
    ...
    <div className="hidden xl:flex items-center gap-6 xl:gap-8">
      ...
      <a href="/src/assets/resume.pdf" target="_blank" download="Ankit_Pradhan_Resume.pdf" className="text-white hover:text-blue-400 transition-colors text-sm lg:text-base">Resume</a>
    </div>
...
>
  ...
  <div
    ...
    onClick={() => setMenuOpen(false)}
  >
    <a href="#" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="menu-link cursor-pointer">Home</a>
    ...
    <a href="/src/assets/resume.pdf" target="_blank" download="Ankit_Pradhan_Resume.pdf" className="menu-link">Resume</a>
  </div>
  ...
  >
    ...
    <a href="/src/assets/resume.pdf" target="_blank" download="Ankit_Pradhan_Resume.pdf" onClick={() => setMenuOpen(false)} className="mobile-menu-link">Resume</a>
  </div>
</div>
